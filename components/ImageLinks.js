...
function ImageLinks() {
  return (
    <ImageLinksStyles id='links'>
      <ImageLink link='/commissions' image={crab}>
        Commissions
      </ImageLink>
      <ImageLink link='https://store.lisa-alley.com' image={seascape}>
        Store
      </ImageLink>
      <ImageLink link='/contact' image={oysters}>
        Contact
      </ImageLink>
      <ImageLink link='/gallery' image={purslane}>
        Gallery
      </ImageLink>
    </ImageLinksStyles>
  );
